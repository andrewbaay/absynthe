//==================================================================================================
//
// Max Maton's Physically Based Rendering shader modifed by Graham Dianaty for Project Absynthe
// Highly experimental.
//
//==================================================================================================
...
extern ConVarRef mat_fullbright("mat_fullbright");
extern ConVarRef mat_specular("mat_specular");
...
END_SHADER_PARAMS
	...
	SHADER_INIT_PARAMS()
	{
		...
		params[PBRLOOKUP]->SetStringValue("engine/pbr_lookup");
		params[FLASHLIGHTTEXTURE]->SetStringValue("effects/flashlight001");
